...
//        wait = new WebDriverWait(driver, Duration.ofSeconds(10));
    ...
    public void testPageTitleShown(){
        ...
        WebElement pageTitle = driver.findElement(By.className("text-center"));

        Assert.assertTrue(pageTitle1.isDisplayed());
        Assert.assertEquals(pageTitle1.getText(), "Buttons");
